...
export const formSchema = z.object({
  name: z
    ...
    .min(2, { message: "Mínimo dos caractéres." })
    .max(50, { message: "Máximo cincuenta caractéres." }),
  description: z
    .string({ required_error: "Este campo es requerido." })
    .min(2, { message: "Mínimo dos caractéres." }),
  basePrice: z.coerce
  ...
  category_id: z
    .string({ required_error: "Este campo es requerido." })
    .min(2, { message: "Debe seleccionar una categoría." }),
  variants: z.array(
    z.object({
      colors: z
        .array(z.string())
      ...
      stock: z.coerce
        .number({ required_error: "Este campo es requerido." })
        .gt(-1, { message: "Introduzca la cantidad disponible de unidades." }),
    })
  ),
});
...
const CreateProductForm = () => {
  ...
  useEffect(() => {
    ...
    const baseCost = form.getValues("baseCost");
  ...
  }, [form.watch("basePrice"), form.watch("baseCost")]);
                        ...
                        >
                          ...
                          <div className="grid md:grid-cols-2 grid-cols-1 gap-5 mt-2">
                            ...
                            <div className="grip gap-3">
                              <FormField
                                control={form.control}
                                name={`variants.${index}.isDiscountPermanent`}
                                render={({ field }) => (
                            ...
                            {!form.watch(
                              `variants.${index}.isDiscountPermanent`
                            ) && (
                              <div className="grip gap-3">
                                <FormField
                                  control={form.control}
